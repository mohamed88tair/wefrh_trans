# config.py - إعدادات البرنامج ومفاتيح API
"""
...
class Config:
    ...
    def __init__(self):
        ...
        self.settings = {
            ...
            'auto_save': True,
            'auto_save_interval': 5,  # بالدقائق
            'backup_files': True,
            'batch_size': 10,
            'max_retries': 3,
            'timeout': 30,
            'connection_timeout': 180,  # 3 دقائق للحفظ التلقائي عند انقطاع الاتصال
            'show_key_column': False,  # إخفاء عمود المفتاح
            'column_widths': {
                'original': 300,
                'translation': 300,
                'status': 120,
